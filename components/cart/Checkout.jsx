                      ...
                      <DialogFooter>
                        <div>
                          <p>
                            ...
                            coupon is non-transferable and cannot be combined
                            with other offers. Validity dates apply. The issuer
                            reserves the right to modify or terminate this offer
                ...
                <div className="grid w-full items-center gap-1.5 px-8 my-7">
                  ...
                  <Select disabled={true}>
                    <SelectTrigger className="bg-transparent border border-white text-base">
                      <SelectValue
                        placeholder={"debit credits from my account"}
                      />
                    </SelectTrigger>
